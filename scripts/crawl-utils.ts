...
import type { Document } from "@/lib/vector-types";
import { BATCH_SIZE, UPSTASH_MAX_DATA_SIZE } from "@/lib/vector-types";

dotenv.config({ path: ".env.local" });

// Re-export types and constants for backward compatibility
export type { Document } from "@/lib/vector-types";
export { BATCH_SIZE, UPSTASH_MAX_DATA_SIZE } from "@/lib/vector-types";
